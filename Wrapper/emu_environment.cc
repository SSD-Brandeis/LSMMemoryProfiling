...
void EmuEnv::ReSetLevelDeletePersistenceLatency(int _level_count, EmuEnv *_env)
{ // reset dpl-per-level when there in a new level added
  ...
  for (int i = 0; i < _level_count - 1; ++i)
  { // i=0 corresponds to level-1
