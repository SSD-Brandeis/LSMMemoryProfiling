...
R = REPO_ROOT / "data" / "ondisk_subcompactions_sweep_skiplist"
OUT = R / "plots"
...
def main():
    ...
    ax.set_title("on-disk 100\\% insert, skiplist: throughput vs "
                 "max\\_subcompactions (bg\\_jobs=8, mwb=8, buffer=8MB, "
                 "uw=1, T=10, key=128B, val=896B, ops=450K)")
    ax.legend(loc="best", frameon=True, framealpha=0.9)
    fig.tight_layout()
    out_path = OUT / "write_throughput_subcompactions_sweep_skiplist.pdf"
