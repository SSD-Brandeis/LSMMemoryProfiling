...
R = REPO_ROOT / "data" / "memtable_scalability_vs_threads_ondisk_scaled"
OUT = R / "plots"
...
def plot_write_memtable(data, memtable, config_str, out_path):
    ...
    ax.set_title(f"on-disk 100\\% insert, {latex_escape(MEMTABLE_DISPLAY_NAMES.get(memtable, memtable))}: "
