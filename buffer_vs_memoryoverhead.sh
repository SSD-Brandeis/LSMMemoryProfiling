...
BUFFER_SIZES_KB=(64 128 256 512 1024 2048 4096 8192 16384)

mkdir -p .vstats
cd .vstats || exit

for BUFFER_KB in "${BUFFER_SIZES_KB[@]}"; do
    PAGES_PER_FILE=$((BUFFER_KB / 4))

    echo -e "\n========================================"
    echo "BUFFER_SIZE      : ${BUFFER_KB}KB"
    echo "PAGES_PER_FILE   : $PAGES_PER_FILE"
    echo "========================================\n"

    EXP_DIR="experiments-${TAG}-B${BUFFER_KB}KB-I${INSERTS}"
