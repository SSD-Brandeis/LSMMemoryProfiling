...
EXPERIMENT_ROOT = REPO_ROOT / "data" / "memtable_scalability_vs_threads_ondisk_scaled_l2"
WORKLOAD_SCRATCH = EXPERIMENT_ROOT / "_workload"
RUNNER_SCRIPT = "run_scripts/run_memtable_scalability_ondisk_scaled_l2.py"
PLOT_SCRIPT = "plot_scripts/plot_memtable_scalability_ondisk_scaled_l2.py"
...
WRITE_SPEC = EXPERIMENT_ROOT / "write_100pct" / "concurrency_write_ondisk_scaled_l2.spec.json"
READ_SPEC = EXPERIMENT_ROOT / "read_100pct" / "concurrency_read_ondisk_scaled_l2.spec.json"
...
MIXED_LOAD_SPEC = EXPERIMENT_ROOT / "mixed_50_50" / "concurrency_mixed_load_ondisk_scaled_l2.spec.json"
MIXED_SPEC = EXPERIMENT_ROOT / "mixed_50_50" / "concurrency_mixed_timed_ondisk_scaled_l2.spec.json"

WRITE_OP_COUNT = 7_000_000
READ_LOAD_OP_COUNT = 7_000_000
READ_QUERY_OP_COUNT = 200_000
MIXED_LOAD_OP_COUNT = 7_000_000
...
def write_manifest(scenario, bg_jobs_list, unordered_write_list,
    ...
    manifest["provenance"] = {
        ...
        "command_setup": {
            "write": "python3 run_scripts/run_memtable_scalability_ondisk_scaled_l2.py --scenario write",
            "read": "python3 run_scripts/run_memtable_scalability_ondisk_scaled_l2.py --scenario read",
            "mixed": "python3 run_scripts/run_memtable_scalability_ondisk_scaled_l2.py --scenario mixed",
            "plot": "python3 plot_scripts/plot_memtable_scalability_ondisk_scaled_l2.py",
        },
        "metric_definitions": {
...
def main():
    ...
    parser.add_argument("--data-root", default=None,
                        help="Override the data output root (default: "
                             ...
                             "scaled_l2). Use this for sanity checks only, so "
