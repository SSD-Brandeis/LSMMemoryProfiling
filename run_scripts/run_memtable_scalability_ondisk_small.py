...
EXPERIMENT_ROOT = REPO_ROOT / "data" / "memtable_scalability_vs_threads_ondisk_small"
WORKLOAD_SCRATCH = EXPERIMENT_ROOT / "_workload"
RUNNER_SCRIPT = "run_scripts/run_memtable_scalability_ondisk_small.py"
PLOT_SCRIPT = "plot_scripts/plot_memtable_scalability_ondisk_small.py"
...
WRITE_SPEC = EXPERIMENT_ROOT / "write_100pct" / "concurrency_write_ondisk_small.spec.json"
READ_SPEC = EXPERIMENT_ROOT / "read_100pct" / "concurrency_read_ondisk_small.spec.json"
...
MIXED_LOAD_SPEC = EXPERIMENT_ROOT / "mixed_50_50" / "concurrency_mixed_load_ondisk_small.spec.json"
MIXED_SPEC = EXPERIMENT_ROOT / "mixed_50_50" / "concurrency_mixed_timed_ondisk_small.spec.json"

WRITE_OP_COUNT = 300_000
READ_LOAD_OP_COUNT = 100_000
READ_QUERY_OP_COUNT = 10_000
MIXED_LOAD_OP_COUNT = 100_000
...
def write_manifest(scenario, bg_jobs_list, unordered_write_list,
    ...
    manifest["provenance"] = {
        ...
        "command_setup": {
            "write": "python3 run_scripts/run_memtable_scalability_ondisk_small.py --scenario write",
            "read": "python3 run_scripts/run_memtable_scalability_ondisk_small.py --scenario read",
            "mixed": "python3 run_scripts/run_memtable_scalability_ondisk_small.py --scenario mixed",
            "plot": "python3 plot_scripts/plot_memtable_scalability_ondisk_small.py",
        },
        "metric_definitions": {
...
def main():
    ...
    parser.add_argument("--data-root", default=None,
                        help="Override the data output root (default: "
                             ...
                             "small). Use this for sanity checks only, so "
