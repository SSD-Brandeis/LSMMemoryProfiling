...
# Updated to new multiphase data paths
EXPERIMENT_DIRS = {
    "interleave": Path(
        "/Users/cba/Desktop/LSMMemoryBuffer/data/filter_result_multiphase_interleave_inmemory_314/sanitycheck-multiphase_interleave-I-740000-U-0-PQ-50000-RQ-1000-S-0.1-Low_Pri0/buffer-2-vector-dynamic"
    ),
    "rawop": Path(
...
def plot_get_latency():
    ...
    # Adjust top to make room for scientific notation if it appears
    ...
    # Updated x-ticks to handle 100,000 queries
