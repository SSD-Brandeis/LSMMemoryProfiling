...
# Phase 3 workload: 10 million insert, 1000 range query
...
# ==============================================================================
DATA_BASE_DIR = Path("/Users/cba/Desktop/LSMMemoryBuffer/data/filter_result_multiphase_ondisk_3phase_1mb_t6_newwl")

# Changed from a set {} to a dictionary {: Path()}
DATA_DIRS = {
    "1MB_Setup": Path("/Users/cba/Desktop/LSMMemoryBuffer/data/filter_result_multiphase_ondisk_3phase_1mb_t6_newwl/-multiphase_ondisk_3phase_1mb_t6_newwl_1MB-I-1000000-U-0-PQ-0-RQ-1000-S-0.0001-Low_Pri0-Size_Ratio6"),
}

PLOTS_DIR = Path("/Users/cba/Desktop/LSMMemoryBuffer/notebooks/paper_plot/ondisk_fig21_1mb_t6_3phases_newwl")
