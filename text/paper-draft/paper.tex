...
\definecolor{warning}{rgb}{1, 0.5, 0}
\definecolor{myYellow}{rgb}{1, 0.64, 0.8}
...
\newcommand{\note}[1]{\textcolor{myYellow}{\textbf{Note: }#1}}
...
\keywords{LSM-tree, Write-buffer, Memtable, Sorted String Table}
