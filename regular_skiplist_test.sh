...
# TAG=regular_skiplist_test_collisioncost_sequential_ondisk_1gb_feb3
TAG=regular_skiplist_test_collisioncost_sequential_inmemory_modifiedskiplist_innerclock_feb4

SETTINGS="lowpri_true"
LOW_PRI=1
#1gb data, 1048576*1024 (entry size)
# INSERTS=1048576
INSERTS=100000
UPDATES=0
RANGE_QUERIES=10
...
for PAGE_SIZE in "${PAGE_SIZES[@]}"; do
    ...
    # 16mb
    # elif [ "$PAGE_SIZE" -eq 4096 ];  then PAGES_PER_FILE_LIST=(4096)
